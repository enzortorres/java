...
public class GameController {
    ...
    /** Sorteia uma seleção para a máquina, excluindo a do jogador. */
     ...
     * Resultado: +1 jogador ganhou, -1 máquina ganhou, 0 empate.
     */
    ...
    private int[] atributos(Carta c) {
        return new int[]{ c.getTitulos(), c.getGols(), c.getParticipacoes(),
                          c.getPontosFifa(), c.getJogadoresEstrela() };
    }
