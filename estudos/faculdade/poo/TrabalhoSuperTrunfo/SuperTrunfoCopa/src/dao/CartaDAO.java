    ...
    public List<Carta> listarTodas() {
        ...
        try (BufferedReader br = new BufferedReader(
            ...
            while ((linha = br.readLine()) != null) {
                ...
                int     titulos          = Integer.parseInt(c[4].trim());
                int     gols             = Integer.parseInt(c[5].trim());
                int     participacoes    = Integer.parseInt(c[6].trim());
                int     pontosFifa       = Integer.parseInt(c[7].trim());
                int     jogadoresEstrela = Integer.parseInt(c[8].trim());
                ...
                cartas.add(new Carta(id, codigo, nome, continente,
                        titulos, gols, participacoes, pontosFifa,
                        jogadoresEstrela, superTrunfo, paisCodigo));
            }
